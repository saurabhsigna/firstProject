...
export default function App() {
  ...
  return (
    <>
      <NextSeo
        title="Contact Us on Phone ~ +91 8368118716 or email ~ freeschooool786@gmail.com | Personal Mentor"
        description="Anything unclear or need help ?  Relax, we are ready to support 24/7 for you. Contact Us on Phone ~ +91 8368118716 or email ~ freeschooool786@gmail.com "
        openGraph={{
          title:
            "Contact Us on Phone ~ +91 8368118716 or email ~ freeschooool786@gmail.com | Personal Mentor",
          description: `Anything unclear or need help ?  Relax, we are ready to support 24/7 for you. Contact Us on Phone ~ +91 8368118716 or email ~ freeschooool786@gmail.com`,
      ...
      <section class="relative py-20 md:py-32 overflow-hidden">
        ...
        <div class="relative container px-4 mx-auto">
          <div class="max-w-2xl mx-auto mb-18 text-center">
            <h1 className="hidden">
              Contact Us on Phone ~ +91 8368118716 or email ~
              freeschooool786@gmail.com | Personal Mentor abhinav, hiro uchiha
              hiro.arcaned.live
            </h1>
            <span class="inline-block py-1 px-3 mb-4 text-xs font-semibold text-orange-900 bg-orange-50 rounded-full">
              READY TO SUPPORT
            </span>
            <h2 class="font-heading text-5xl xs:text-6xl font-bold text-gray-900 mb-4">
