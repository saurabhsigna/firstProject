  ...
  return (
    <Backdrop onClick={handleClose}>
      <motion.div
        ...
        className="modal mx-auto max-w-700 min-w-1/2 md:w-[50vw] w-[80vw] max-h-300 min-h-1/2 h-1/2  rounded-md flex flex-col items-center bg-gradient-to-r from-yellow-500 to-red-500 transform -skew-x-10 "
        variants={dropIn}
        initial="hidden"
        animate="visible"
        exit="exit"
